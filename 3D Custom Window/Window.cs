...
namespace _3D_Custom_Window
{
    ...
    public static class Window
    {
        ...
        private static extern IntPtr CreateWindowEx(WindowStylesEx dwExStyle, string lpClassName, string lpWindowName,
        ...
        public static void Run(String[] args)
        {
            ...
            CreateWindowEx(windowBehavior, "3dWindow", "3D Custom Window", windowStyle, x, y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam);
        }
    }
}
