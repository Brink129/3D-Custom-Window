...
namespace _3D_Custom_Window
{
    ...
    public static class Window
    {
        ...
        // Delegates for WNDCLASS
        public delegate IntPtr WndProc(IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam);

        /// <summary>
        /// enums for use in methods
        /// </summary>



        // http://www.pinvoke.net/default.aspx/Enums/ClassStyles.html  
        // These are diffent class sytles for the characteristics of windows behaviors
        // These can be found here: https://learn.microsoft.com/en-us/windows/win32/winmsg/window-class-styles
        [Flags]
        ...
        // These are style Short cuts for the different types of styles of windows you can have found
        // Here: https://learn.microsoft.com/en-us/windows/win32/winmsg/extended-window-styles
        [Flags]
        ...
        /// They can be found here: https://learn.microsoft.com/en-us/windows/win32/winmsg/window-styles
        /// </summary>  
        [Flags()]
        ...
        // These are brushes for the background
        ...
        {
            WindowStylesEx windowBehavior = WindowStylesEx.WS_EX_LEFT;
            int x = -1;
            int y = -1;
            int nWidth = -1;
            int nHeight = -1;
            ...
            //Stuff for the window registration
